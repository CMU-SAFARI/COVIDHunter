...
let M =           [0, 0.35, 0.66,  0.7, 0.65, 0.63, 0.5, 0.35, 0.5, 0.65, 0.69, 0.7, 0.7, 0.7, 0.55, 0.35, 0.55]
let TRANSITIONS = [1,   58,   76,  100,  132,  151, 174,   235, 274,  303, 320, 330, 356, 387, 425, 475,  505, 9999] // Day from start of sim that we move to next pandemic 'phase'. Last entry should be 9999
