...
let Y = 0.02730 //the deaths-to-cases ratio, for CRW-100% = 2.730% for CTC-100% = 1.739%
...
let M =           [0, 0.45, 0.7,  0.7, 0.65, 0.63, 0.5, 0.36, 0.37, 0.6, 0.71, 0.71, 0.71, 0.73, 0.7, 0.73, 0.73]
