...
let M =           [0, 0.45, 0.7,  0.7, 0.65, 0.63, 0.5, 0.355, 0.6, 0.7, 0.7, 0.71, 0.73, 0.73, 0.355, 0.73]
let TRANSITIONS = [1,   58,  77,  118,  132,  151, 174,   245, 284, 303, 320,  330,  356, 387,   425,  456, 9999] // Day from start of sim that we move to next pandemic 'phase'. Last entry should be 9999
